...
console.log(
  ...
  async function createBookInstances() {
    console.log("Adding authors");
    await Promise.all([
      bookInstanceCreate(0, books[0], "London Gollancz, 2023.", false, "Available"),
      bookInstanceCreate(1, books[1], " Gollancz, 2023.", false, "Loaned"),
      bookInstanceCreate(2, books[2], " Gollancz, 2023.", false, false),
      bookInstanceCreate(3,
        books[3],
        "New York Tom Doherty Associates, 2023.",
        false,
        "Available"
      ),
      ...
      bookInstanceCreate(6,
        books[4],
        "New York, NY Tom Doherty Associates, LLC, 2023.",
        false,
        "Available"
      ),
